...
function Home() {
  ...
  return (
    <div style={{display:'flex'}}>
      <div style={{alignItems:"left", marginLeft:20, marginRight:20, textAlign:'left'}}>
        ...
        <div style={{height:600, backgroundColor:'rgb(255 172 40)', marginTop:30, marginBottom:40}}>
            <div>
        ...
        <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
            <div>
                <p style={{width: '300px', textAlign: 'center', fontWeight:'bold', fontSize:20}}>Wow, you got this far, huh?</p>
            </div>
